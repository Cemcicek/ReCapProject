...
namespace Business.Constants
{
    public static  class Message
    {
        ...
        public static string RentalNameInvalid = "Kiralama geçersiz";

        public static string CustomerAdded = "Müşteri eklendi";
        public static string CustomerDeleted = "Müşteri silindi";
        public static string CustomerUpdated = "Müşteri güncellendi";
        public static string CutomerListed = "Müşteri Listesi";
        public static string CustomerNameInvalid = "Müşteri geçersiz";

        public static string FailAddedImageLimit = "En fazla 5 fotoğraf eklenebilir.";
